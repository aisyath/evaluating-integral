...
# Definisi nilai exact_value
exact_value = 289.43515  # Nilai eksak yang sesuai
...
print(f"Segments: {n_value}, Distance: {result_trapezoidal}, Error (%): {abs(result_trapezoidal - exact_value) / exact_value * 100}")
